...
int main() {
  ...
  printf("População: Carta_1 vence Carta_2? (%d)\n", populacao_1 > populacao_2);
  printf("Área: Carta_1 vence Carta_2? (%d)\n", area_1 > area_2);
  printf("PIB: Carta_1 vence Carta_2? (%d)\n", pib_1 > pib_2);
  printf("Número de pontos turísticos: Carta_1 vence Carta_2? (%d)\n", pts_turisticos_1 > pts_turisticos_2);
  printf("Densidade Populacional: Carta_1 vence Carta_2? (%d)\n", densidade_populacional_1 < densidade_populacional_2);
  printf("PIB per Capita: Carta_1 vence Carta_2? (%d)\n", pib_per_capita_1 > pib_per_capita_2);
  printf("Super Poder: Carta_1 vence Carta_2? (%d)\n", super_poder_1 > super_poder_2);
